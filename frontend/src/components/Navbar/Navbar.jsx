    ...
    return (
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img classNameName="img-fuild" src={logo} alt="Adack Land" /></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <ul>
                                    ...
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                </ul>
                                <ul>
                                    <li class="dropdown-item text-warning">Another action</li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                </ul>
                                <ul>
                                    <li class="dropdown-item text-warning">Something else here</li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                                    <li><a class="dropdown-item text-dark" href="#">Mega Menu Link</a></li>
                        ...
                        <li className="nav-item1 d-flex">
                            <i className="bi bi-bookmark-heart text-danger"></i>
                            <a className="nav-link" aria-current="page" href="#">علاقه مندی</a>
                        </li>
                        <li className="nav-item2">
                            <a className="nav-link" href="#"><button><i className="bi bi-arrow-bar-left px-2"></i>ورود | ثبت نام</button></a>
                        </li>
                        <li className="nav-item3">
